...
const HeaderNavLink = ({ href, children })=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
        href: href,
        className: cn("inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700", active ? "border-indigo-500 text-gray-900" : ""),
        children: children
    });
};
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/k3ytoshi/iD-PWA/src/components/layouts/Header.tsx`)
