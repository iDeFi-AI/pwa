  ...
  const sections: SectionProps[] = [
    {
      ...
      content: '',
      imageUrl: '/home.gif',
      imageAlt: '/cube.gif', // Update alt text to be more descriptive
    },
    {
      title: 'Overview of iDeFi.ai',
      content:
        'Welcome to the innovative world of iDeFi.ai, where blockchain technology and artificial intelligence converge to shape the future of decentralized finance (DeFi).',
      paragraphs: [
    ...
    },
    {
      title: 'Our Mission',
      content:
        'At iDeFi.ai, our mission is to create a financial ecosystem that prioritizes security, efficiency, and inclusivity. We believe that the synergy between AI and blockchain is the foundation upon which the future of DeFi is built.',
      paragraphs: [
        ...
        'Inclusivity is a core value we hold dear. We aim to break down barriers and make financial services accessible to everyone. By embracing blockchain transparency and AIs adaptability, we are creating an ecosystem that welcomes users from all walks of life. This inclusivity is what makes iDeFi.ai stand out in the world of DeFi.',
      ],
    },
    {
      title: 'Core Objectives',
      content:
        'Our core objectives include democratizing finance, making cryptocurrency accessible to traditional financial institutions, and reshaping the financial landscape using advanced AI techniques.',
      paragraphs: [
    ...
    },
    {
      ...
      content:
        'iDeFi.ai is at the forefront of the DeFi revolution. Our commitment to user-friendliness, robust security measures, and AI-driven solutions positions us as a trailblazer in the decentralized finance sector.',
      paragraphs: [
        ...
        'Robust security measures are the foundation of trust. Our commitment to security is not just a promise; it is an ongoing process. We continuously refine and enhance our security protocols to provide users with peace of mind and protect their digital assets.',
    ...
    },
    {
      ...
      content:
        'Explore the key initiatives being built and tested at iDeFi.ai. Access real-time transaction data, AI-driven insights, and more to secure and optimize your financial operations.',
      paragraphs: [
    ...
    },
    {
      title: 'API Suite',
      content:
        'Our API suite provides access to real-time transaction data, AI-driven insights, and more to secure and optimize your financial operations.',
      paragraphs: [
      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
        {sections.map((section, index) => (
          <div className="section" key={index}>
            ...
            {index !== 0 && <br />}
            {section.title === 'Welcome to iDeFi.AI' && (
              <p className="mb-4">
                <Link
                  href="/terms"
                  className="text-neorange underline hover:underline"
                >
                  Review our Educational and Ethical Disclosure
                </Link>
              </p>
            )}
            {section.paragraphs && (
            ...
            {section.imageUrl && index === 0 && ( // Load only the first image with priority
              <div className="mt-4">
                <Image
                  layout="responsive"
                  objectFit="cover"
                  ...
                  priority={true} // Load the first image with priority
                />
              </div>
            )}
            {index !== 0 && (
        ...
        <div className="mt-12 text-center">
          <Link href="https://api.idefi.ai">
            <button className="text-neorange hover:text-black px-4 py-2 border border-neorange rounded-md">
              iDeFi.ai API
            </button>
          </Link>
        </div>
